...
// TASK: l�obiettivo � distruggere la farfalla. 
// Quando la farfalla viene colpita non viene pi� disegnata.

//NOTA La farfalla � disegnata con la curva parametrica che la descrive, 
// il cannone � fatto con le primitive di base.
...
bool checkCollision(Figura obj1, Figura obj2) {
	...
	//Ha collisione se c'� collisione sia nella direzione x che nella direzione y
